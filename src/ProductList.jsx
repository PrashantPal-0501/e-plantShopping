...
const plantCategories = [
  {
    ...
    plants: [
      ...
      },
      {
        name: 'Boston Fern',
        price: 14,
        image: 'https://source.unsplash.com/400x400/?bostonfern',
        description: 'Adds humidity to the air and filters toxins.',
      },
      {
        name: 'Rubber Plant',
        price: 16,
        image: 'https://source.unsplash.com/400x400/?rubberplant',
        description: 'Broad glossy leaves that clean indoor air.',
      },
      {
        name: 'Areca Palm',
        price: 22,
        image: 'https://source.unsplash.com/400x400/?arecapalm',
        description: 'A natural humidifier that purifies the air.',
      },
    ],
  },
  {
    ...
    plants: [
      ...
      },
      {
        name: 'Mint',
        price: 10,
        image: 'https://source.unsplash.com/400x400/?mint,herb',
        description: 'Refreshing scent, great for teas and cooking.',
      },
      {
        name: 'Basil',
        price: 11,
        image: 'https://source.unsplash.com/400x400/?basil,herb',
        description: 'Sweet, peppery aroma and a kitchen favorite.',
      },
      {
        name: 'Eucalyptus',
        price: 19,
        image: 'https://source.unsplash.com/400x400/?eucalyptus',
        description: 'Invigorating scent that clears the sinuses.',
      },
    ],
  },
  {
    ...
    plants: [
      ...
      },
      {
        name: 'Jade Plant',
        price: 13,
        image: 'https://source.unsplash.com/400x400/?jadeplant',
        description: 'Thick, glossy leaves said to bring good luck.',
      },
      {
        name: 'Zebra Cactus',
        price: 15,
        image: 'https://source.unsplash.com/400x400/?zebracactus',
        description: 'Striking striped foliage, easy to care for.',
      },
      {
        name: 'Burro\u2019s Tail',
        price: 18,
        image: 'https://source.unsplash.com/400x400/?burrostail,succulent',
